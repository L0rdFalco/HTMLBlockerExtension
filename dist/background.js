...
/* harmony import */ var logging__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! logging */ "./node_modules/logging/lib/browser.js");
...
var logger = (0,logging__WEBPACK_IMPORTED_MODULE_1__["default"])('bgScript');
var allowed = true;
var prefs = {
...
chrome.runtime.onMessage.addListener(function (msg, sender, sendResponse) {
  if (msg.action === "toolsVisibStatus") msg.visible ? onIcon() : offIcon();else if (msg.action === "persist_perm_hidden_elms") {
    (0,idb_keyval__WEBPACK_IMPORTED_MODULE_2__.set)("web:".concat(msg.website), msg.data);
  } else if (msg.action === "extract_perm_hidden_elms") {
    (0,idb_keyval__WEBPACK_IMPORTED_MODULE_2__.get)("web:".concat(msg.website)).then(function (data) {
      sendResponse(data || "[]");
    });
  ...
  _setLocalStorageRule = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(pattern, newSetting, incognito) {
    ...
    return _regeneratorRuntime().wrap(function _callee10$(_context10) {
      while (1) switch (_context10.prev = _context10.next) {
        ...
        case 2:
          _context10.t0 = lodash__WEBPACK_IMPORTED_MODULE_0__.merge;
          _context10.t1 = lodash__WEBPACK_IMPORTED_MODULE_0__.clone;
          _context10.next = 6;
          return chrome.storage.local.get("imgTF_rules");
        case 6:
          _context10.t2 = _context10.sent;
          _context10.t3 = (0, _context10.t1)(_context10.t2);
          data = (0, _context10.t0)(_context10.t3);
